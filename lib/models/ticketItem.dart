  ...
  Widget build(BuildContext context) {
    return InkWell(
        onTap: () {
          showDialog(
              context: context,
              builder: (BuildContext context) => ticketDetail(context));
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Text('Ticket Date: ' +
                            DateFormat('yyyy-MM-dd').format(infractionDate))
                      ],
                    ),
                    // SizedBox(height: 5),
                    Row(
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: new Text(
              "This will delete your ticket, and you will have to re-submit the ticket."),
          actions: <Widget>[
